...
const Blog: React.FC<BlogProps> = ({ 
  topics = ['Study Abroad', 'IELTS', 'Student Visa', 'Scholarships', 'University Guide'],
  articles = [] 
}) => {
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 bg-white font-inter">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {articles.map((article) => (
          <div key={article.id} className="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 cursor-pointer">
